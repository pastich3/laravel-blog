...
At the conclusion of Boot Camp participants identify opportunities for their organization to execute a similar strategy. Tatham facilitators also discuss how to leverage the Tatham Group’s systematic method to achieve breakthrough levels of business performance and financial results as well as developing a list of potential target processes that will be strategic and valuable to redesign.',
    ...
    'michael_tatham_content' => 'Idea man, artist, aviator and athlete; I take pride in the ability to engage in new experiences and break through the limits of commonplace thinking. A true advocate of experimentation and discovery, I wholeheartedly follow the scientific method and am inspired by the ambiguity it sometimes creates.
...
Which makes my work a perfect fit. I have the opportunity to work with leaders, managers and workers across many industries and around the world. Travel has allowed my adventurous spirit explore new places, customs and foods like raw herring out of the North sea, durian fruit in Malaysia and kangaroo loin in the southern USA, strange but true. It has also taught me to respect my surroundings while always being true to myself.',
    ...
    'client_results_array' => [
        [
            'name' => 'AEGON Canada',
            'content' => 'created $1.4 million in freed capacity and reduced headcount by 17%.'
        ],
        [
            'name' => 'AEGON USA',
            'content' => 'reduced cost per item by 60%, increased sales volume by 300% without resource changes, and found $32,000 in savings when developing their Fixed Annuity Product.'
        ],
        [
            'name' => 'BANK OF AMERICA',
            'content' => 'saved of hundreds of millions of dollars by redesigning at least 12 major processes and fixing 33 ‘dumb things’ they did to customers. These included cutting the time it takes to open a new account; reducing the time it takes to redeem a CD from 9 days to 10 minutes; streamlining and simplifying small business loans, real estate loans, fixed rate home equity loans; and improving the customer experience when replacing ATM cards.'
        ],
        [
            'name' => 'BANK OF PHILIPPINE ISLANDS',
            'content' => 'branches went from zero cross-selling efforts to a significant increase in sales and dramatically reduced the time it takes to approve an auto loan (now it only takes 6 hours).'
        ],
        [
            'name' => 'CANADA LIFE',
            'content' => 'documented a 30% improvement in productivity in one of their large divisions in a year alone, and another 20% over the next two years just based on growth in volumes and attrition. This resulted in $200,000 to the bottom line not as a cost reduction, but in new business otherwise gone to competition.'
        ],
        [
            'name' => 'CANADELLE',
            'content' => 'began shipping its product at a 95% fill rate (up from 85%) and operating with $5,000,000 less in inventory. As a result, profits rose 21% and RoI went up 10 points. In July 2002, staff received the highest bonus payout in the history of the company.'
        ],
        [
            'name' => 'CREDIT VALLEY HOSPITAL',
            'content' => 'tackled the cancer patient experience at the Peel Regional Cancer Center. Normally, what should have only taken 2 hours, was taking an average of anywhere from 5.5 – 8.5 hours. The redesigned process shortened the wait time to 34 minute and increased the number of treatments per day from 42 to 65.'
        ],
        [
            'name' => 'EQUITABLE LIFE',
            'content' => 'gained more than 30% in capacity and productivity in the areas they focused on. It has achieved about $785,000 in savings annually.'
        ],
        [
            'name' => 'NASA',
            'content' => 'redesigned the operations process for the Hubble Space Telescope so that wait time for scientists went from 18 months to 3 weeks and cut cost by $100M.'
        ],
        [
            'name' => 'WELLS FARGO',
            'content' => 'shortened the time for the central corporate authority to approve projects from 30 days to 1 day. The HR Recruiting Department has found hidden capacity and $2.8 million process dollars. The redesigned wire transfer process reduced error rates, improved the customer experience (from 3 weeks to 10 minutes to send a wire) and freed up capacity in operations and financial centers. Wachovia Treasury services had three teams in succession design the new customer-based process. Since the E-Box project was released in January, no customer has reported a single defect. All of testing found less than 1 defect out of 100 chances.'
        ],
...
As the leader of this company you can’t understand why those infuriating problems won’t go away. You call in your best people, but their efforts take too long. So you bring an outside consultant, but without buy-in from your front line people, before you know it, just like in the movie, ‘Groundhog Day™’, the same problem is recurring, over and over again. Welcome to The CEO’s Cycle of Hell.',
	...
	'start_journey_content' => 'At The Tatham Group, we know that the most challenging part of the journey is just getting started – admitting there may be a better way of operating. That’s why we begin by creating an emotional experience for our clients through what we call Boot Camp.
...
The big ‘aha’ moment for many people is when they see that no matter what the challenge is, they can fix it, because it’s not beyond them – they feel confident they can come up with their own solutions in a systematic and disciplined way.',
	...
	'clients_content' => 'When you break free from recurring problems, the results can be nothing short of transformational.
