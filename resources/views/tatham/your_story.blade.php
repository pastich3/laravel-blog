...
@section('content')
	<div class="justify-content-center d-flex font-weight-bolder huge"> {{ __('tatham.your_story') }} </div>
		<div style="border: 1px solid black; background-color: #D1D1D1" class="px-3 pb-3">
			<span class="justify-content-center d-flex huge"> {{ __('tatham.your_story_content.inaction_mega_header') }} </span>
			<div style="border: 1px solid gray; background-color: #C1C1C1" class="p-3">
			...
			<div style="border: 1px solid gray; background-color: #C1C1C1" class="mt-3 p-3">
