...
use App\Workflow\Models\WorflowTaskTypeMap;
...
class WorkflowTaskProcessor {
    ...
    public function process()
    {
        ...
        {
            case WorflowTaskTypeMap::REMINDER: {
                $result = new WorkflowTaskProcessor($this->currentComponent)->process();
                break;
            }
            case WorflowTaskTypeMap::USER_ACTION: {
                break;
            }
            default: {
                throw new \Exception(
